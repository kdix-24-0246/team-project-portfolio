...
M5StackとWebアプリケーションを連携させ、ポモドーロタイマーやToDo管理機能を実装し、学習中のスマートフォン利用による集中力低下を防ぐことを目的として開発をしました。
 ...
 M5Stackを傾けるとTodo管理と、ポモドーロタイマー機能を行き来でき、タッチで各操作を行う事ができます。
...
### 2. チーム開発における進捗管理
他メンバーより技術力、開発力が乏しいため、サブリーダーとして、メンバーの進捗確認や日程調整を行いました。週一回の情報共有を通じて、週間報告書の作成、チーム全体が開発状況や問題点を把握できる環境づくりに取り組みました。
...
### M5Stack表示画面
![M5Stack表示画面](<スクリーンショット 2026-06-21 22.04.25.png>)
![](<スクリーンショット 2026-06-21 22.04.48.png>)

## 学んだこと

本プロジェクトを通じて、利用者視点を意識しながら画面設計を行う中で、見やすさと操作性を両立させることの難しさと面白さを学びました。  
