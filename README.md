...
- 完了／未完了管理
- カテゴリ分類
![alt text](<スクリーンショット 2026-06-21 22.06.46.png>)
![alt text](<スクリーンショット 2026-06-21 22.06.14.png>)

### ポモドーロタイマー機能
- 作業時間・休憩時間の設定
- 設定履歴の保存
- 学習サイクルの管理
![alt text](<スクリーンショット 2026-06-21 22.06.46-1.png>)
...
### ToDo管理画面
![ToDo管理画面](images/todo.png)

### ポモドーロタイマー設定画面
![ポモドーロタイマー設定画面](images/timer.png)

### M5Stack表示画面
![M5Stack表示画面](images/m5stack.png)

## 学んだこと

本プロジェクトを通じて、HTML/CSSによるUI設計だけでなく、チーム開発における進捗管理や役割分担の重要性を学びました。また、利用者視点で操作しやすい画面を設計することの難しさと面白さを経験することができました。